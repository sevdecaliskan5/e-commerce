    ...
    <div className="bg-[#2A7CC7] h-auto md:h-[636px]">
      <div className="w-full flex justify-center">
        <div className="w-full md:w-[1440px] flex flex-col md:flex-row items-center justify-between px-4 md:px-0">
          <div className="flex flex-col items-center text-center gap-6 w-full md:w-[500px] py-12 md:py-28 text-white">
            <h5 className="font-bold text-base">WORK WITH US</h5>

            <h2 className="font-bold text-3xl md:text-[40px] text-center">
              Now Let's grow Yours
            </h2>
            <p className="font-normal text-sm text-center max-w-[500px]">
