    ...
    <div>
      <div className="flex flex-col gap-20 py-16 text-center items-center">
        <div className="header">
          <div className="max-w-[633px] flex flex-col gap-[10px] font-bold">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-8 cards">
          <div className="h-[343px]">
            <div className="flex flex-col gap-[15px] py-[50px] px-10 text-[#252B42] items-center">
              ...
              <button className="text-primary-color border border-1 border-primary-color rounded-[37px] py-[15px] px-[36px] font-bold text-sm hover:opacity-80 transition">
                Submit Request
              </button>
            </div>
          </div>
