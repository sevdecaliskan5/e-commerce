      ...
      <div className="flex flex-col sm:flex-row items-center gap-4">
        ...
        <div className="flex gap-2 border border-[#E0E0E0] p-1 rounded-md">
          <button
            ...
            className={`text-lg px-2 py-1 rounded ${layout === "grid" ? "bg-[#23A6F0] text-white" : "hover:bg-gray-100"} cursor-pointer`}
          >
            🔲
          </button>
          <button
            onClick={() => setLayout("list")}
            className={`text-lg px-2 py-1 rounded ${layout === "list" ? "bg-[#23A6F0] text-white" : "hover:bg-gray-100"} cursor-pointer`}
          >
            ☰
          </button>
        </div>
