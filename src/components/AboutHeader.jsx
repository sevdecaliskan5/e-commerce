...
const AboutHeader = () => {
  return (
    <div className="flex flex-col md:flex-row items-center justify-center gap-8 md:gap-[120px] py-6 md:py-28 px-4 md:px-0">
       <div className="flex flex-col items-center md:items-start text-center md:text-start gap-4 w-full md:w-[356px]">
        <h5 className="text-[#252B42] text-base font-bold">ABOUT COMPANY</h5>
        <h1 className="text-[#252B42] text-4xl md:text-[58px] font-bold leading-tight">ABOUT US</h1>
        <p className="text-sm md:text-base max-w-[300px] md:max-w-none">We know how large objects will act, but things on a small scale</p>
        <Link
          to="/team"
